<?php namespace riuson\EveApi\Commands\Char;
...
class AssetList extends Command {

	/**
	 *
	 * @var string The console command name
	 */
	protected $name = "eveapi:char/asset-list";

	/**
	 *
	 * @var string The console command description
	 */
	protected $description = "Requests a list of assets owned by character.";
	...
	public function fire()
	{
		...
		try {
			...
			$methodInfo = EveApiCallsLibrary::char_assetList();
